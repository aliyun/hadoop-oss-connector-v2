...
public class ContractTestUtils {
  ...
  public static void verifyFileContents(FileSystem fs,
    ...
    org.junit.jupiter.api.Assertions.assertEquals(original.length, stat.getLen(), "wrong length " + statText);
   ...
   */
  public static void downgrade(String message, Throwable failure) throws Exception {
  ...
  public static void assertIsDirectory(FileStatus fileStatus) {
    assertTrue(fileStatus.isDirectory(),"Should be a directory -but isn't: " + fileStatus);
  }
  ...
  public static void assertErasureCoded(final FileSystem fs, final Path path)
      throws IOException {
    FileStatus fileStatus = fs.getFileStatus(path);
    org.junit.jupiter.api.Assertions.assertTrue(fileStatus.isErasureCoded(),
        path + " must be erasure coded!");
  }
  ...
  public static void assertDeleted(FileSystem fs,
    ...
    org.junit.jupiter.api.Assertions.assertTrue(deleted, "Delete failed on " + file + ": " + dir);
  ...
  public static void assertRenameOutcome(FileSystem fs,
    ...
    org.junit.jupiter.api.Assertions.assertEquals(expectedResult, result,
        String.format("Expected rename(%s, %s) to return %b,"
  ...
  public static void assertIsFile(Path filename, FileStatus status) {
    ...
    org.junit.jupiter.api.Assertions.assertFalse(status.isDirectory(),
        "File claims to be a directory " + fileInfo);
    org.junit.jupiter.api.Assertions.assertFalse(status.isSymlink(),
  ...
  public static void assertListStatusFinds(FileSystem fs,
    ...
    org.junit.jupiter.api.Assertions.assertTrue(found, "Path " + subdir
  ...
  public static final class TreeScanResults {
    ...
    public void assertSizeEquals(String text, long f, long d, long o) {
      ...
      assertEquals(f, getFileCount(), text + ": file count in " + self);
      assertEquals(d, getDirCount(), text + ": directory count in " + self);
      assertEquals(o, getOtherCount(), text + ": 'other' count in " + self);
    }
    ...
    public void assertFieldsEquivalent(String fieldname,
      ...
      org.junit.jupiter.api.Assertions.assertFalse(containsDuplicates(ours),
          "Duplicate  " + fieldname + " in " + this + ": " + ourList);
      org.junit.jupiter.api.Assertions.assertFalse(containsDuplicates(theirs),
          "Duplicate  " + fieldname + " in other " + that + ": " + theirList);
      org.junit.jupiter.api.Assertions.assertTrue(collectionsEquivalent(ours, theirs),
          fieldname + " mismatch: between " + ourList + " and " + theirList);
    }
