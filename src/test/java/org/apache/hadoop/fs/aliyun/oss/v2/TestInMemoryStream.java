 ...
 */
public class TestInMemoryStream {
...
//  private String impl;
    ...
    private void initFs(String ossClientImpl, String FileSystemImpl) throws IOException {
        ...
        conf.set(READAHEAD_RANGE, "4");
        conf.set(SMALL_FILE_THRESHOLD_KEY, "100");
...
//          "org.apache.hadoop.fs.aliyun.oss.DefaultOSSClientFactory","org.apache.hadoop.fs.aliyun.oss.AliyunOSSFileSystem",
    ...
    public void testWriteAndReadSmallFile(String ossClientImpl, String FileSystemImpl) throws IOException {
...
//            assertEquals(2, bytesRead, "Should read the same number of bytes");
//            assertArrayEquals(new String(testDataBytes).substring(0, 5).getBytes(), buffer, "Should read the same data");
        }
    }
//
//    @ParameterizedTest
