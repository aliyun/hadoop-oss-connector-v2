 ...
 */
public final class OSSDataBlocks {
     ...
     */
    public static BlockFactory createFactory(AliyunOSSPerformanceFileSystem owner,
                                             String name) {
        switch (name) {
    ...
    public static abstract class BlockFactory implements Closeable {
        private final AliyunOSSPerformanceFileSystem owner;

        protected BlockFactory(AliyunOSSPerformanceFileSystem owner) {
            this.owner = owner;
        }
         ...
         * Owner.
         */
        protected AliyunOSSPerformanceFileSystem getOwner() {
            return owner;
        }
    }
    ...
    static abstract class MemoryBlockFactory extends BlockFactory {
        ...
        MemoryBlockFactory(AliyunOSSPerformanceFileSystem owner) {
            super(owner);
        }
    ...
    static class ArrayBlockFactory extends MemoryBlockFactory {
        ...
        ArrayBlockFactory(AliyunOSSPerformanceFileSystem owner) {
            super(owner);
        }
    ...
    static class ByteBufferBlockFactory extends MemoryBlockFactory {
        ...
        ByteBufferBlockFactory(AliyunOSSPerformanceFileSystem owner) {
            super(owner);
        }
    ...
    static class DiskBlockFactory extends BlockFactory {
        ...
        DiskBlockFactory(AliyunOSSPerformanceFileSystem owner) {
            super(owner);
        }
    ...
    static class MemoryAndDiskBlockFactory extends BlockFactory {
        ...
        MemoryAndDiskBlockFactory(AliyunOSSPerformanceFileSystem owner,
