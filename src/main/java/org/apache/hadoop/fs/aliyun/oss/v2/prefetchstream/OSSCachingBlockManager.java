...
public class OSSCachingBlockManager extends CachingBlockManager {
    ...
    @Override
    public int read(ByteBuffer buffer, long startOffset, int size, ObjectAttributes objectAttributes, RemoteLogContext remoteLogContext)
            throws IOException {
        return this.reader.read(buffer, startOffset, size, objectAttributes, remoteLogContext);
    }
