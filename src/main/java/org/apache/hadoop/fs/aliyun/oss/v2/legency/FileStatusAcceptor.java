...
import static org.apache.hadoop.fs.aliyun.oss.v2.legency.AliyunOSSUtils.objectRepresentsDirectory;
...
public interface FileStatusAcceptor {
     ...
     * should be generated.
     */
    boolean accept(Path keyPath, ObjectSummaryParam summary);
    ...
    class AcceptFilesOnly implements FileStatusAcceptor {
         ...
         */
        @Override
        public boolean accept(Path keyPath, ObjectSummaryParam summary) {
